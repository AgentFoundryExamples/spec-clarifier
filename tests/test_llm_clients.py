...
class TestOpenAIResponsesClient:
    ...
    async def test_openai_client_missing_api_key_error(self, monkeypatch):
        ...
        from app.services.llm_clients import LLMCallError, OpenAIResponsesClient
    ...
    async def test_openai_client_authentication_error(self, monkeypatch):
        ...
        from app.services.llm_clients import LLMAuthenticationError, OpenAIResponsesClient
    ...
    async def test_openai_client_rate_limit_error(self, monkeypatch):
        ...
        from app.services.llm_clients import LLMRateLimitError, OpenAIResponsesClient
    ...
    async def test_openai_client_validation_error(self, monkeypatch):
        ...
        from app.services.llm_clients import LLMValidationError, OpenAIResponsesClient
    ...
    async def test_openai_client_network_error(self, monkeypatch):
        ...
        from app.services.llm_clients import LLMNetworkError, OpenAIResponsesClient
